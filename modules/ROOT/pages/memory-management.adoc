...
:description: In this guide, we will learn how to both measure and restrict memory usage in Neo4j.
...
Familiarity with the xref:cypher:index.adoc[Cypher query language] is required to understand the examples used in this guide.
...
image::{img}memory-management-movies-graph.jpg[role="popup-link"]
...
image::{img}query-plan-with-memory.png[role="popup-link",width=200]
