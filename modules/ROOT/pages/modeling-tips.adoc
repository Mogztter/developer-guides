...
.Prerequisites
[abstract]
You should understand xref:graph-database.adoc[what a graph database is] and know the components of the link:/developer/get-started/guide-data-modeling[property graph data model].
