...
There is a xref:cypher:index.adoc[Cypher tutorial] if you would like to learn more.
...
The following example is in Ruby on Rails, but there is a xref:sinatra-ex[Sinatra example^] below.
