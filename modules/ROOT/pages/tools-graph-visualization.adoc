...
[TIP]
====
_Neo4j Bloom is now available for free and is readily available in https://neo4j.com/download/[Neo4j Desktop^]. xref:neo4j-bloom.adoc[This guide] will provide more information on getting started._
====
