...
To do this we'll use a function from the xref:ROOT:neo4j-apoc.adoc[APOC library,window=_blank] to parse the string.
...
* xref:ROOT:neo4j-apoc.adoc[APOC library,window=_blank]
